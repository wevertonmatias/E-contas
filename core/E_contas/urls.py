...
urlpatterns = [
    ...
    path('adm/lista/pagamento', ListarPagamento.as_view(), name='lista_pagamento'),
    ...
    path('adm/atualiza/pagamento/<int:pk>/', AtualizarPagamento.as_view(), name='atualiza_pagamento'),
    ...
    # path('graficos-pagamento/', GraficoPagamento, name='graficos-pagamento'),
